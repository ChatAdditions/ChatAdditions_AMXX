...
Storage_Save(const name[], const authID[], const IP[], const reason[], const adminName[], const adminAuthID[], const adminIP[], const expireAt, const flags)
{
...
public handle_SavedResult(failstate, Handle: query, error[], errnum, data[], size, Float: queuetime)
{
	...
	enum
	{
		res_name, res_authid, res_ip, res_reason,
